export const Titulos = () => {
  return (
    <section className="bg-gray-50">
      <div className="mx-auto max-w-screen-xl px-4 py-32 md:py-4 lg:flex lg:flex-col  lg:items-center">
        ...
        <div className="mx-auto text-center">
          ...
          <p className="mt-4 md:text-[22px]">
            Sí… te brindamos a través de esta página todo lo que tenes que saber
            para que tu presentación sea la correcta!
          </p>
        </div>
      </div>
    </section>
